...
export default function TimetableGrid({ events, canEdit, courseUnits }: { events: any[], canEdit: boolean, courseUnits: any[] }) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '60px repeat(5, 1fr)', gap: '1px', background: 'var(--border-subtle)', border: '1px solid var(--border-subtle)', borderRadius: '8px', overflow: 'hidden' }}>
