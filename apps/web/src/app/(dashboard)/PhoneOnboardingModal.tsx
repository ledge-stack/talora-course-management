  ...
  return (
    <div className="modal-content" style={{ background: 'var(--color-bg-surface)', padding: '2rem', borderRadius: '16px', maxWidth: '450px', width: '100%', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontStyle: 'italic', fontSize: '1.5rem', fontWeight: 700, color: 'var(--color-text-primary)' }}>One more step</h2>
          <p style={{ color: 'var(--color-text-secondary)', marginTop: '0.5rem', fontSize: '0.9375rem' }}>{otpSent ? 'Enter the verification code sent to your phone.' : 'Complete your profile to continue to the dashboard.'}</p>
        </div>
          ...
          <form onSubmit={handleVerifyOtp} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div>
              ...
              <input
                ...
                placeholder="123456"
                required
                style={{ width: '100%', fontFamily: 'var(--font-mono)', letterSpacing: '0.1em', textAlign: 'center', fontSize: '1.125rem' }}
              />
            </div>
            <button type="submit" className="btn-primary" style={{ width: '100%', marginTop: '0.5rem', padding: '0.75rem' }} disabled={loading}>
