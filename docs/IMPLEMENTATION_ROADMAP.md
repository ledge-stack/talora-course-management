...
- **Description:** Flutter mobile app exists for student group discovery, announcements, and timetable. OTP verification screens for registration and password reset are pending implementation.
...
| Mobile OTP screens | Flutter registration and password reset need OTP input UI |
