...
- **Description:** Implement validation rules for student numbers (`YY007XXXXXa`), registration numbers (`YY/U/XXXXX`), year prefix consistency (`YY`), group min/max capacity, and group status derivation.
